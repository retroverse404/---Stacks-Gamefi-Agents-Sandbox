...
export class Game {
  ...
  private showPremiumInteractionPanel(object: SemanticInteractable, offer: PremiumOfferRecord) {
    ...
    status.textContent = walletAddress && walletProviderId
    ...
    body.textContent = walletAddress && walletProviderId
    ...
    connectXverseBtn.style.cssText = `
    ...
    connectLeatherBtn.style.cssText = connectXverseBtn.style.cssText;
